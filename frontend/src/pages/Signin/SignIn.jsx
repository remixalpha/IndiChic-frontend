...
import productFirst from "../../assets/images/coat.jpg";
import productSecond from "../../assets/images/shorts.jpg";
import productThird from "../../assets/images/Men/pants/Chinese Style Cotton and Linen Pants Striped 2.jpeg";
import productFourth from "../../assets/images/women/sweaters/𝗥𝗠.jpeg";
...
export default function SignIn() {
  ...
  return (
    <>
      <div className=" flex  min-h-screen flex-1 flex-col lg:grid lg:grid-cols-2 justify-center px-6  lg:px-8 bg-black">
          ...
          <div className=" relative z-50 -mt-20 ">
            ...
            <form className="space-y-10 mt-10 " method="POST">
              <div className=" border-b-2 relative flex flex-col items-center justify-center ">
                <button
                  type="button"
                  className="text-white w-full  justify-center bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:ring-[#4285F4]/50 font-medium rounded-[1rem] text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
                >
                  <svg
                ...
                <button
                  type="button"
                  className="text-white w-full mb-10 justify-center bg-black hover:bg-gray-800 font-medium rounded-[1rem]  text-sm px-5 py-2.5 text-center inline-flex items-center  mr-2 "
                >
                  <svg
