      ...
      <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div className="sm:max-w-lg">
            ...
            <a
              href="/"
              className="inline-block mt-5 rounded-primary border border-transparent bg-white px-14 py-5 text-center font-medium text-black "
            >
          ...
          <div>
            <div className=" mt-[20rem] lg:mt-10  ">
              {/* Images */}
              <div
                aria-hidden="true"
                className="pointer-events-none hidden lg:flex lg:absolute lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl  "
              >
                <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8 ">
                  <div className="flex items-center space-x-6 lg:space-x-8">
                    <div className="  group grid flex-shrink-0 lg:grid-cols-1 gap-y-6 lg:gap-y-8 animate-images-scroll">
              ...
              <div
                aria-hidden="true"
                className="pointer-events-none lg:hidden   mx-auto w-full max-w-7xl"
              >
                <div className="absolute  mt-[20rem] transform left-1/2 top-1/2 -translate-y-1/2 -translate-x-16 ">
                  <div className="flex  items-center  space-y-[55rem] ">
                    <div className="  group flex flex-row flex-shrink-0 gap-x-6 animate-images-scrolling ">
                      <div className=" h-[20rem] w-[20rem] overflow-hidden rounded-[2rem]  opacity-100   ">
                        <img
                          src={promo1}
                          alt=""
                          className="h-full w-full object-cover object-center"
                    ...
                    <div className="flex flex-row flex-shrink-0 gap-x-6 animate-images-scrollings ">
                      <div className="h-[30rem] w-[20rem] overflow-hidden rounded-[2rem]">
                        <img
                          src={promo5}
                          alt=""
