...
import LOGO from "../../assets/images/Logo/indichic-logo-max.svg";
    ...
    <header className="bg-primary ">
      ...
      >
        ...
        <div className="  lg:flex lg:flex-1 lg:justify-center lg:relative lg:right-[6rem] ">
          <a href="/" className="-m-1.5 p-1.5 flex flex-row space-x-6 ">
            {/* <img className="h-8 w-auto" src={LOGO} alt="" /> */}

            <span className="text-white font-bold text-4xl">indichic</span>
          </a>
        </div>
